// not working but it has a lot of the logic
...
void CurrentLoop() {
    ...
    float cycleTime = t%T;
    float fractTime = t%(T/5) / (T/5);

    if cycleTime < 0.2 * T
        posDesired_1 = angle1_1 + (angle1_2 - angle1_1) * fractTime

    else if cycleTime < 0.4 * T

    else if cycleTime < 0.6 * T

    else if cycleTime < 0.8 * T

    else
        posDesired_4 = angle4_5 + (angle4_1 - angle4_5) * fractTime
...
void setInputParams(const float* input_params) {
    ...
    // get joint angles
    angle1_1 = input_params[1];
    angle1_2 = input_params[2];
    angle1_3 = input_params[3];
    angle1_4 = input_params[4];
    angle1_5 = input_params[5];

    angle2_1 = input_params[6];
    angle2_2 = input_params[7];
    angle2_3 = input_params[8];
    angle2_4 = input_params[9];
    angle2_5 = input_params[10];

    angle3_1 = input_params[11];
    angle3_2 = input_params[12];
    angle3_3 = input_params[13];
    angle3_4 = input_params[14];
    angle3_5 = input_params[15];

    angle4_1 = input_params[16];
    angle4_2 = input_params[17];
    angle4_3 = input_params[18];
    angle4_4 = input_params[19];
    angle4_5 = input_params[20];
